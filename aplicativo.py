...
def scrape_mercadolivre(term, quantity):
    ...
    product_links = driver.find_elements(By.CSS_SELECTOR, '.ui-search-results li.ui-search-layout__item .ui-search-item__group .ui-search-link')

    for product_link in product_links[:quantity]:
        try:
            installments_element = driver.find_element(By.XPATH, '//span[contains(@class, "ui-search-installments") and contains(text(), "x")]')
